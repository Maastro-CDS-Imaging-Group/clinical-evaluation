...
def parse_args(args):
    ...
    parser.add_argument(
        dest="image_path",
        help=
        "Path to image that can be read by SimpleITK",
        type=Path)
    ...
    parser.add_argument(
        ...
        dest="dicom_path",
        help=
        "Path to dicom file to carry over metadata from",
        type=Path)
    ...
    parser.add_argument(
        ...
        dest="output_dir",
        help=
        "Path to save the created dicom, if directory does not exist it will be created",
